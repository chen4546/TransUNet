...
if __name__ == "__main__":
    ...
    dataset_config = {
        ...
        'BUSI-256': {
            'Dataset': Synapse_dataset,
            'volume_path':'../data/BUSI-256/test_vol_h5',
            'list_dir': './lists/lists_BUSI-256',
            'num_classes': 2,
            'z_spacing': 1,
        },
        'isic2018': {
            'Dataset': Synapse_dataset,
            'volume_path': '../data/isic2018/test/test_vol_h5',
            'list_dir': './lists/lists_isic2018',
            'num_classes': 2,
            'z_spacing': 1,
        }
    }
    ...
    snapshot = r'D:\Visual studio\code\pycharm\TransUNet\model\TU_BUSI-256256\TU_pretrain_R50-ViT-B_16_skip3_epo100_bs6_256\best_model.pth'
    #snapshot=r'D:\Visual studio\code\pycharm\TransUNet\model\TU_isic2018256\TU_pretrain_R50-ViT-B_16_skip3_epo100_bs6_256\best_model.pth'
